...
const UI_EN = {
  ...
  "저장 {done}/{total}": "Saving {done}/{total}",
  "{n}개 실패 — 다시 저장": "{n} failed. Save again",
  "저장 완료 ✓ 오프라인 가능": "Saved ✓ available offline",
  "개정됨 · 도면 다시 저장": "Updated · save drawings again",
  "저장됨 · 다시 저장": "Saved · save again",
